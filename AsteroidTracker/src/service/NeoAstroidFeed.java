...
//        Log.i("neo", "DATA: "+data);
    ...
    public List<NearEarthObject> getRecentList(String DATA){
    ...
    public List<NearEarthObject> getUpcomingList(String DATA){
    ...
    public List<Impact> getImpactList(String DATA){
