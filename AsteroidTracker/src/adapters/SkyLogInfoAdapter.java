...
public class SkyLogInfoAdapter extends ArrayAdapter {
    ...
    public SkyLogInfoAdapter(Context context, int textViewResourceId, List objects) {
        super(context, textViewResourceId, objects);
        resourceId = textViewResourceId;
        res = context.getResources();
    }

    public SkyLogInfoAdapter(Context context, int textViewResourceId) {
